  ...
  return (
    <section className="section page-section" data-reveal>
      <div className="section-head">
        ...
        <p>Real problems, real solutions. Here's how Rep Rummble helps you succeed.</p>
      </div>
      ...
      <div className="accordion" data-stagger>
        <details className="accordion-item" open>
          ...
          <p>
            ...
            <strong>Our Solution:</strong> Rep Rummble sends smart reminders based on your eating patterns.
        ...
        <details className="accordion-item">
          ...
          <p>
            ...
            <strong>Example:</strong> Mike was stuck at 185 lbs for 3 weeks. Rep Rummble noticed his calories
        ...
        <details className="accordion-item">
          ...
          <p>
            ...
            <strong>Our Solution:</strong> Log your mood alongside meals. Rep Rummble identifies patterns —
        ...
        <details className="accordion-item">
          ...
          <p>
            ...
            <strong>Our Solution:</strong> Sync your wearable to track sleep. Rep Rummble adjusts your daily
        ...
        <details className="accordion-item">
          ...
          <p>
            ...
            <strong>Our Solution:</strong> Tell us your goal (lose fat, build muscle, maintain). Rep Rummble
        ...
        <details className="accordion-item">
          ...
          <p>
            ...
            <strong>Our Solution:</strong> Rep Rummble calculates your lean bulk surplus (usually 200-300 kcal above maintenance)
        ...
        <details className="accordion-item">
          ...
          <p>
            ...
            <strong>Our Solution:</strong> Rep Rummble syncs with Apple Health, Google Fit, Fitbit, Garmin,
        ...
        <details className="accordion-item">
          ...
          <p>
            ...
            <strong>Example:</strong> Try it for 2 weeks free. If Rep Rummble isn't right for you, cancel anytime
