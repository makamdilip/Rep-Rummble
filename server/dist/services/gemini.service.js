...
exports.analyzeFoodImageWithGemini = analyzeFoodImageWithGemini;
exports.quickLogMealWithGemini = quickLogMealWithGemini;
exports.generateWorkoutPlanWithGemini = generateWorkoutPlanWithGemini;
exports.getNutritionInfoWithGemini = getNutritionInfoWithGemini;
 ...
 */
async function analyzeFoodImageWithGemini(imageBase64, mealType) {
    try {
        if (!genAI) {
 ...
 */
async function quickLogMealWithGemini(description) {
    try {
        if (!genAI) {
            return getMockFoodAnalysis();
        }
 ...
 */
async function generateWorkoutPlanWithGemini(goal, fitnessLevel, daysPerWeek) {
    try {
        if (!genAI) {
 ...
 */
async function getNutritionInfoWithGemini(foodName) {
    try {
        if (!genAI) {
