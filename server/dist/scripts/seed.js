...
async function seed() {
    ...
    await Exercise_model_1.Exercise.deleteMany({ isAIGenerated: false });
    console.log('🗑  Cleared existing exercises');
    // Seed exercises
    const exercises = await Exercise_model_1.Exercise.insertMany(EXERCISES.map(e => ({ ...e, isActive: true, isAIGenerated: false })));
