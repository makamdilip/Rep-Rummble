...
- Use the service for unlawful or abusive content

See `docs/policies/ACCEPTABLE_USE.md` for details.

## 5) Content and data

You retain ownership of content you submit.
You grant us a license to store and process it to operate the service.
...
We may integrate third-party services (e.g., Supabase, Oracle, Gemini, Vercel).
Their terms and policies apply to their services.
